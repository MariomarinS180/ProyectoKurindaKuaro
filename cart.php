              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="product-piezas">Piezas</th>
                ...
                ?>
                  <tr>
                    ...
                    <td class="product-piezas">
                      <h2 class="h5 text-black"><?php echo $arregloCarrito[$i]['Piezas']; ?></h2>
                    </td>
          ...
          <div class="col-md-6">
            <div class="row mb-5">
              <div class="col-md-6 mb-3 mb-md-0">
                <a href="cart.php"><button class="btn btn-primary btn-sm btn-block"> Actualizar Carrito </button></a>
              </div>
              <div class="col-md-6">
